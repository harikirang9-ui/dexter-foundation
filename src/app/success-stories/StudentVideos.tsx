...
export default function StudentVideos() {
  return (
    <div className="grid grid-cols-3 gap-4 md:gap-6 max-w-[1000px] mx-auto">
      <VideoCard videoId="8htBs7dVVDE" title="Student Experience 1" />
      <VideoCard videoId="4VTYGcvYxkg" title="Student Experience 2" />
      <VideoCard videoId="DnR1dcSCrZs" title="Student Experience 3" />
    </div>
  );
}
